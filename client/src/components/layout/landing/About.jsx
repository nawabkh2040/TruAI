...
const About = () => {
  return (
    <section id="about" className="w-full bg-[#0B0E1A] py-10 pt-60 pb-24 px-6 flex justify-center">
      <motion.div
      ...
      >
        ...
        <p className="text-gray-400 text-lg leading-relaxed max-w-4xl mx-auto mt-6">
